...
for _ in range(len(df.index)):
    ...
    # 前
    pixels[0][4] = df_line[1]
    pixels[0][6] = df_line[2]
    pixels[0][8] = df_line[3]
    pixels[1][3] = df_line[4]
    pixels[1][5] = df_line[5]
    pixels[1][7] = df_line[6]
    pixels[1][9] = df_line[7]
    pixels[2][4] = df_line[8]
    pixels[2][6] = df_line[9]
    pixels[2][8] = df_line[10]

    # 後ろ
    pixels[3][1] = df_line[11]
    pixels[3][3] = df_line[12]
    pixels[3][5] = df_line[13]
    pixels[3][7] = df_line[14]
    pixels[3][9] = df_line[15]
    pixels[3][11] = df_line[16]
    pixels[4][0] = df_line[17]
    pixels[4][2] = df_line[18]
    pixels[4][4] = df_line[19]
    pixels[4][6] = df_line[20]
    pixels[4][8] = df_line[21]
    pixels[4][10] = df_line[22]
    pixels[4][12] = df_line[23]
    pixels[5][1] = df_line[24]
    pixels[5][3] = df_line[25]
    pixels[5][5] = df_line[26]
    pixels[5][7] = df_line[27]
    pixels[5][9] = df_line[28]
    pixels[5][11] = df_line[29]
    pixels[6][0] = df_line[30]
    pixels[6][2] = df_line[31]
    pixels[6][4] = df_line[32]
    pixels[6][6] = df_line[33]
    pixels[6][8] = df_line[34]
    pixels[6][10] = df_line[35]
    pixels[6][12] = df_line[36]
    pixels[7][1] = df_line[37]
    pixels[7][3] = df_line[38]
    pixels[7][5] = df_line[39]
    pixels[7][7] = df_line[40]
    pixels[7][9] = df_line[41]
    pixels[7][11] = df_line[42]
    pixels[8][0] = df_line[43]
    pixels[8][2] = df_line[44]
    pixels[8][4] = df_line[45]
    pixels[8][6] = df_line[46]
    pixels[8][8] = df_line[47]
    pixels[8][10] = df_line[48]
    pixels[8][12] = df_line[49]
    pixels[9][1] = df_line[50]
    pixels[9][3] = df_line[51]
    pixels[9][5] = df_line[52]
    pixels[9][7] = df_line[53]
    pixels[9][9] = df_line[54]
    pixels[9][11] = df_line[55]
    pixels[10][0] = df_line[56]
    pixels[10][2] = df_line[57]
    pixels[10][4] = df_line[58]
    pixels[10][6] = df_line[59]
    pixels[10][8] = df_line[60]
    pixels[10][10] = df_line[61]
    pixels[10][12] = df_line[62]
    pixels[11][1] = df_line[63]
    pixels[11][3] = df_line[64]
    pixels[11][5] = df_line[65]
    pixels[11][7] = df_line[66]
    pixels[11][9] = df_line[67]
    pixels[11][11] = df_line[68]
