...
for _ in range(len(df.index)):
    ...
    # 前
    pixels[0][4] = df_line[119]
    pixels[0][6] = df_line[121]
    pixels[0][8] = df_line[123]
    pixels[1][3] = df_line[125]
    pixels[1][5] = df_line[127]
    pixels[1][7] = df_line[129]
    pixels[1][9] = df_line[131]
    pixels[2][4] = df_line[133]
    pixels[2][6] = df_line[135]
    pixels[2][8] = df_line[137]

    # 後ろ
    pixels[3][1] = df_line[3]
    pixels[3][3] = df_line[5]
    pixels[3][5] = df_line[7]
    pixels[3][7] = df_line[9]
    pixels[3][9] = df_line[11]
    pixels[3][11] = df_line[13]
    pixels[4][0] = df_line[15]
    pixels[4][2] = df_line[17]
    pixels[4][4] = df_line[19]
    pixels[4][6] = df_line[21]
    pixels[4][8] = df_line[23]
    pixels[4][10] = df_line[25]
    pixels[4][12] = df_line[27]
    pixels[5][1] = df_line[29]
    pixels[5][3] = df_line[31]
    pixels[5][5] = df_line[33]
    pixels[5][7] = df_line[35]
    pixels[5][9] = df_line[37]
    pixels[5][11] = df_line[39]
    pixels[6][0] = df_line[41]
    pixels[6][2] = df_line[43]
    pixels[6][4] = df_line[45]
    pixels[6][6] = df_line[47]
    pixels[6][8] = df_line[49]
    pixels[6][10] = df_line[51]
    pixels[6][12] = df_line[53]
    pixels[7][1] = df_line[55]
    pixels[7][3] = df_line[57]
    pixels[7][5] = df_line[59]
    pixels[7][7] = df_line[61]
    pixels[7][9] = df_line[63]
    pixels[7][11] = df_line[65]
    pixels[8][0] = df_line[67]
    pixels[8][2] = df_line[69]
    pixels[8][4] = df_line[71]
    pixels[8][6] = df_line[73]
    pixels[8][8] = df_line[75]
    pixels[8][10] = df_line[77]
    pixels[8][12] = df_line[79]
    pixels[9][1] = df_line[81]
    pixels[9][3] = df_line[83]
    pixels[9][5] = df_line[85]
    pixels[9][7] = df_line[87]
    pixels[9][9] = df_line[89]
    pixels[9][11] = df_line[91]
    pixels[10][0] = df_line[93]
    pixels[10][2] = df_line[95]
    pixels[10][4] = df_line[97]
    pixels[10][6] = df_line[99]
    pixels[10][8] = df_line[101]
    pixels[10][10] = df_line[103]
    pixels[10][12] = df_line[105]
    pixels[11][1] = df_line[107]
    pixels[11][3] = df_line[109]
    pixels[11][5] = df_line[111]
    pixels[11][7] = df_line[113]
    pixels[11][9] = df_line[115]
    pixels[11][11] = df_line[117]
